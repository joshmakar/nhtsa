A [NPM package](https://www.npmjs.com/package/@joshmakar/nhtsa) for fetching and parsing vehicle data from the [NHTSA Vehicle API](https://vpic.nhtsa.dot.gov/api/Home)
